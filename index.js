...
Module['FS_createPath']("/", "cache_assets", true, true);
    ...
    loadPackage({"files": [{"filename": "/cache_assets/Brick.png", "start": 0, "end": 82408}, {"filename": "/cache_assets/Ceiling.png", "start": 82408, "end": 229998}, {"filename": "/cache_assets/FalloutLondonLogo.png", "start": 229998, "end": 380811}, {"filename": "/cache_assets/Floor.png", "start": 380811, "end": 671034}, {"filename": "/cache_assets/GameOn.png", "start": 671034, "end": 721372}, {"filename": "/cache_assets/Guide.png", "start": 721372, "end": 764628}], "remote_package_size": 764628});

  })();

// end include: /tmp/tmp03gmke82.js
// include: /tmp/tmpd98414_v.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpd98414_v.js
// include: /tmp/tmphzxp7d58.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmphzxp7d58.js
