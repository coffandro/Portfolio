...
Module['FS_createPath']("/", "cache_assets", true, true);
    ...
    loadPackage({"files": [{"filename": "/cache_assets/Brick.png", "start": 0, "end": 82408}, {"filename": "/cache_assets/Ceiling.png", "start": 82408, "end": 229998}, {"filename": "/cache_assets/FalloutLondonLogo.png", "start": 229998, "end": 380811}, {"filename": "/cache_assets/FightForForrestLogo.png", "start": 380811, "end": 431055}, {"filename": "/cache_assets/Floor.png", "start": 431055, "end": 721278}, {"filename": "/cache_assets/GameOn.png", "start": 721278, "end": 771616}, {"filename": "/cache_assets/Guide.png", "start": 771616, "end": 814872}], "remote_package_size": 814872});

  })();

// end include: /tmp/tmprogl7mn6.js
// include: /tmp/tmp_jbzapsz.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp_jbzapsz.js
// include: /tmp/tmppn1in45d.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmppn1in45d.js
...
var _close_embed = Module['_close_embed'] = createExportWrapper('close_embed', 0);
